"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{IO:function(){return ss},JU:function(){return iV},QT:function(){return sw},Xo:function(){return sh},ad:function(){return iP},ar:function(){return so},cf:function(){return sI},hJ:function(){return iL},pl:function(){return sE},r7:function(){return sT},vr:function(){return sA}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sw(e){e=iN(e,iR);let t=iN(e.firestore,iF);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new im({next:s=>{t.enqueueAndForget(()=>rB(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rG(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rq(e,a)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(iU(t),e._key).then(n=>sS(t,e,n))}class s_ extends sm{constructor(e){super(),this.firestore=e}convertBytes(e){return new iB(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iR(this.firestore,null,t)}}function sE(e,t,n){var r;e=iN(e,iR);let i=iN(e.firestore,iF),s=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return sC(i,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Nu(s.merge||s.mergeFields?2:0,t,n,i);i4("Data must be an object, but it was:",l,r);let u=i2(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i9(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i7(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new ij(new eO(u),a,o)})(iJ(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,tL.none())])}function sT(e,t,n,...r){e=iN(e,iR);let i=iN(e.firestore,iF),s=iJ(i);return sC(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof i$?function(e,t,n,r,i,s){let a=e.Nu(1,t,n),o=[i9(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i9(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!i7(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Cu(t);if(n instanceof iZ)u.push(t);else{let e=i1(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iW(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Nu(1,t,n);i4("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=i5(t,e,n);r=(0,h.m9)(r);let l=i.Cu(o);if(r instanceof iZ)s.push(o);else{let e=i1(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iW(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tL.exists(!0))])}function sI(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iO(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iO(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iR)a=iN(e.firestore,iF),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](sS(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iN(e,iD);a=iN(n.firestore,iF),o=n._query;let r=new s_(a);s={next:e=>{t[u]&&t[u](new sv(a,r,n,e))},error:t[u+1],complete:t[u+2]},/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query)}return function(e,t,n,r){let i=new im(r),s=new rG(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rq(await i_(e),s)),()=>{i.za(),e.asyncQueue.enqueueAndForget(async()=>rB(await i_(e),s))}}(iU(a),o,c,s)}function sC(e,t){return function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r4(await iw(e).then(e=>e.syncEngine),t,n)),n.promise}(iU(e),t)}function sS(e,t,n){let r=n.docs.get(t._key),i=new s_(e);return new sg(e,i,t._key,r,new sp(n.hasPendingWrites,n.fromCache),t.converter)}function sA(...e){return new i0("arrayUnion",e)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iF(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.0",void 0),(0,o.KN)(m,"4.7.0","esm2017")}()}}]);