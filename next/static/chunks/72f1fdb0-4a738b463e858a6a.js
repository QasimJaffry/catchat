"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[691],{6055:function(e,t,i){i.d(t,{C:function(){return tt},aa:function(){return e8},ab:function(){return e7},o:function(){return ia},y:function(){return te}});var r,n=i(9279),s=i(3943),a=i(9053),o=i(1735),l=i(2680);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tk extends eb{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return eM(e,this._buildIdpRequest())}_linkToIdToken(e,t){return eM(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return eM(e,this._buildIdpRequest())}_buildIdpRequest(e){let t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function tS(e){return e4(e.auth,new tk(e),e.bypassAuthState)}function tR(e){let{auth:t,user:i}=e;return _(i,t,"internal-error"),e9(i,new tk(e),e.bypassAuthState)}async function tP(e){let{auth:t,user:i}=e;return _(i,t,"internal-error"),e2(i,new tk(e),e.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
